...
public class Levels {
    ...
    public static Array<StarModel> getStars1() {
        ...
        stars.add(new StarModel(new Point(128 / 2 + px + px * 2 * 1,
                screenHeight - (128 / 2 + py + py * 2 * 0)), 0, StarModel.Constants.Types.MINE,
                new int[]{1, 2, 3}, new FleetModel()));

        stars.add(new StarModel(new Point(128 / 2 + px + px * 2 * 4,
                screenHeight - (128 / 2 + py + py * 2 * 0)), 0, StarModel.Constants.Types.ADVANCED_FACTORY,
        ...
        stars.add(new StarModel(new Point(128 / 2 + px + px * 2 * 1,
                screenHeight - (128 / 2 + py + py * 2 * 2)), 0, StarModel.Constants.Types.FACTORY,
        ...
        stars.add(new StarModel(new Point(128 / 2 + px + px * 2 * 5,
                screenHeight - (128 / 2 + py + py * 2 * 3)), 0, StarModel.Constants.Types.ADVANCED_FACTORY,
